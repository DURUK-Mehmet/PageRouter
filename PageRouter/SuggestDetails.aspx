<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeFile="SuggestDetails.aspx.cs" Inherits="SuggestDetails" %>
    ...
    <table class="auto-style3">
        ...
        <tr>
            <td colspan="2" style="text-align:center">
                <asp:Button ID="Btn_Accept"  Width="15%" runat="server" Text="Yayınla" OnClick="Btn_Accept_Click"/>
            </td>
        </tr>
    </table>
</asp:Content>
